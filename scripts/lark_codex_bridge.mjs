...
const config = {
  ...
  workdir: resolve(process.env.CODEX_WORKDIR || rootDir),
  vaultDir: resolve(process.env.PERSONAL_CRM_VAULT || "~/Documents/Obsidian/Personal CRM".replace(/^~/, process.env.HOME || "")),
